...
@export var blue_enemy5山口_scene: PackedScene
# 黄色鬼
@export var yellow_enemy_scene: PackedScene
@export var yellow_enemy5山口_scene: PackedScene
# 赤鬼
@export var red_enemy_scene: PackedScene
@export var red_enemy5山口_scene: PackedScene
# 山口ボス
@export var yamaguti_boss_scene: PackedScene
...
# ==================================================
#UIの可視化
@onready var yamaguti_stage_ui = $StageUI
#Waveのラベル更新
...
# Wave1の敵出現間隔
const WAVE_1_SPAWN_TIME: float = 1.2
...
# Wave3へ進むために必要な撃破数
const KILLS_TO_WAVE_3: int = 20

# Wave2の敵出現間隔
const WAVE_2_SPAWN_TIME: float = 0.7
...
# 山口ボス出現に必要な撃破数
const KILLS_TO_YAMAGUTI_BOSS: int = 5

# Wave3の敵出現間隔
const WAVE_3_SPAWN_TIME: float = 1.3
...
# 山口ボスが出現済みか
var yamaguti_boss_spawned: bool = false
...
func game_over() -> void:
	...
	$BGM.stop()
	# 山口ステージUIを非表示する
	yamaguti_stage_ui.visible = false
	...
	match current_wave:
		...
		1:
			...
			# 山口青鬼 60% (残りの確率)
				...
				scene_to_spawn = blue_enemy5山口_scene


		# ==========================================
		# Wave2 (山口青鬼: 15%, 黄色鬼: 35%, 山口黄色鬼: 50%)
		# ==========================================
		2:
			var random_value := randf()
			...
			# 山口黄色鬼 50% (0.50 〜 1.0)
				...
				scene_to_spawn = yellow_enemy5山口_scene


		# ==========================================
		# Wave3 (赤鬼: 30%, 黄色鬼: 10%, 山口赤鬼: 60%)
		# ==========================================
		3:
			var random_value := randf()
			...
			# 山口赤鬼 60% (0.40 〜 1.0)
				...
				scene_to_spawn = red_enemy5山口_scene
	...
	match current_wave:
		...
		3:
			...
			print(
				...
				wave_3_kill_count,
				"/",
				KILLS_TO_YAMAGUTI_BOSS
			)


			# 5体倒したら鳥取ボス
			if wave_3_kill_count >= KILLS_TO_YAMAGUTI_BOSS:

				# ここが重要
				# Physics処理が終わってからボスを生成する
				call_deferred("spawn_yamaguti_boss")
...
func spawn_yamaguti_boss() -> void:
	...
	var boss := yamaguti_boss_scene.instantiate()
...
func _on_yamaguti_boss_died() -> void:
...
func stage_clear() -> void:
	...
	get_tree().change_scene_to_file(
		"res://scenes/mori-mi/game_clear_y.tscn"
	)
